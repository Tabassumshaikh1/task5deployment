...
const PORT = 1000;
const bcrypt = require('bcrypt');//String passwd se hash mai convert karne k lie use hota hai
const crypto=require('crypto');

const saltRounds = 10;//it is  used to calculate cost factor (cost factor means how much time require to convert passwd String to hsj)
//mail sending work
let transporter=nodemailer.createTransport({
    ...
    secure:false,
    auth:{
        user:"ts4449067@gmail.com",
        pass:"hkuwguxgkykybfwx"
    }
});
...
//database connection
mongoose.connect("mongodb+srv://Tabassum:Tabassum1234@cluster0.f8r4yqy.mongodb.net/?retryWrites=true&w=majority")
...
app.post("/postregis",(req, res) => {
    ...
    userModel.create({ email:email,username: uname, password: hash,image:req.file,status:0 })
        .then(data => {
            let mailOptions={
